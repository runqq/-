...
#define DownLoadCell_BigFont            [UIFont systemFontOfSize:18]
#define DownLoadCell_SmollFont          [UIFont systemFontOfSize:15]
...
@property (assign, nonatomic) int64_t bytes;  //1024
...
- (void)layoutSubviews
{
    ...
    H = 15;
    self.totalLabel.frame = CGRectMake(DownloadCell_Spcing, Y, W, H);//
